...
A aplicação foi construída em etapas e o resultado de cada etapa é disponibilizado num ramo. O ramo principal possui a versão mais recente do projeto. Este ramo possui a quarta versão do projeto, em que Axios é utilizado para interagir com a API ao invés de JavaScript puro.
